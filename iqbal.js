...
const namaUser = `${pushname2}`
const umurUser = `${sender}`
const serialUser = createSerial(20)
try {
								ppimg = await iqbal.getProfilePicture(`${sender.split('@')[0]}@c.us`)
								} catch {
